...
**Input**:
```python
from do_workflow_testing import AutomatedCodeReviewer
  ...
  "auto_fixable": [
    {
      "file": "src/auth/service.py",
      "fix": "Add type hints",
      "apply_command": "do-workflow fix --file src/auth/service.py --type hints"
    }
  ]
}
```
...
```python
from do_workflow_testing import QualityGateManager
