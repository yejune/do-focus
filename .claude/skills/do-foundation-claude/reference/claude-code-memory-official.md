...
## Core Do Commands
- /do:0-project: Initialize project structure
- /do:1-plan: Generate SPEC document
- /do:2-run: Execute TDD implementation
- /do:3-sync: Generate documentation
- /do:9-feedback: Collect improvement feedback

## Command Execution Rules
- After /do:1-plan: Execute /clear (mandatory)
- Token threshold: Execute /clear at >150K tokens
- Error handling: Use /do:9-feedback for all issues
```
