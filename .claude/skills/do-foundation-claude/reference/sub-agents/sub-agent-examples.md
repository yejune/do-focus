...
---
name: code-backend
description: Use PROACTIVELY for backend architecture, API design, server implementation, database integration, or microservices architecture. Called from /do:1-plan architecture design and task delegation workflows.
...
model: sonnet
skills: do-domain-backend, do-essentials-perf, do-context7-integration, do-lang-python
---
...
---
name: code-frontend
description: Use PROACTIVELY for frontend UI development, React/Vue/Angular components, responsive design, user experience optimization, or web application architecture. Called from /do:2-run implementation and task delegation workflows.
tools: Read, Write, Edit, Grep, Glob, MultiEdit, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
model: sonnet
skills: do-domain-frontend, do-cc-configuration, do-context7-integration, do-ui-ux-expert
---
...
model: haiku
skills: do-code-quality, do-cc-configuration, do-lang-python
---
...
model: sonnet
skills: do-essentials-debug, do-core-code-reviewer, do-context7-integration
---
...
model: sonnet
skills: do-lang-python, do-domain-testing, do-foundation-quality, do-core-spec-authoring
---
...
tools: Read, Write, Edit, Grep, Glob, Bash, WebFetch, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
model: sonnet
skills: do-domain-security, do-cc-security, do-foundation-quality, do-core-workflow
---
