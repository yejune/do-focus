...
Examples:
- `Use PROACTIVELY for backend architecture, API design, server implementation, database integration, or microservices architecture. Called from /do:1-plan and task delegation workflows. CRITICAL: This agent MUST be invoked via Task(subagent_type='code-backend') - NEVER executed directly.`
...
skills: do-lang-python, do-domain-backend, do-context7-integration

# Load quality and documentation skills
skills: do-foundation-quality, do-docs-generation, do-cc-claude-code
```
...
---
name: code-backend
description: Use PROACTIVELY for backend architecture, API design, server implementation, database integration, or microservices architecture. Called from /do:1-plan and task delegation workflows.
tools: Read, Write, Edit, Bash, WebFetch, Grep, Glob, mcp__context7__resolve-library-id, mcp__context7__get-library-docs
model: sonnet
skills: do-domain-backend, do-essentials-perf, do-context7-integration
---
...
---
name: format-expert
description: Use PROACTIVELY for code formatting, style consistency, linting configuration, and automated code quality improvements. Called from /do:2-run quality gates and task delegation workflows.
tools: Read, Write, Edit, Bash, Grep, Glob
model: haiku
skills: do-code-quality, do-cc-configuration
---
...
---
name: workflow-tdd
description: Execute RED-GREEN-REFACTOR TDD cycle for implementing features with comprehensive test coverage. Called from /do:2-run SPEC implementation and task delegation workflows.
tools: Read, Write, Edit, Bash, Grep, Glob, MultiEdit, TodoWrite
model: sonnet
skills: do-lang-python, do-domain-testing, do-foundation-quality
---
...
---
name: core-quality
description: Validate code quality against TRUST 5 framework (Testable, Readable, Unified, Secured, Trackable). Called from /do:2-run quality validation and task delegation workflows.
tools: Read, Grep, Glob, Bash, Write, Edit
model: sonnet
skills: do-foundation-trust, do-code-quality, do-security-expert
---
...
description: Use PROACTIVELY for complete application development including frontend, backend, database, and deployment. Called from /do:2-run comprehensive implementation and task delegation workflows.
...
model: sonnet
skills: do-domain-backend, do-domain-frontend, do-domain-database, do-devops-expert, do-security-expert
---
