# Do Worktree Reference

Purpose: External resources, documentation, and additional learning materials for do-worktree skill.
...
- Click Framework: [https://click.palletsprojects.com/](https://click.palletsprojects.com/)
 - Command-line interface framework used by do-worktree
...
- Rich Library: [https://rich.readthedocs.io/](https://rich.readthedocs.io/)
 - Terminal output formatting used by do-worktree
...
- do-foundation-core: Foundation principles and delegation patterns
 - Reference: [do-foundation-core modules](do-foundation-core/modules/)
 - Integration: Worktree creation follows foundation delegation patterns

- do-workflow-project: Project management and configuration
 - Reference: [do-workflow-project modules](do-workflow-project/modules/)
 - Integration: Project setup with worktree support

- do-foundation-claude: Claude Code execution patterns
 - Reference: [do-foundation-claude modules](do-foundation-claude/modules/)
...
2. Selective Synchronization: Sync only essential files
 ```bash
 do-worktree sync SPEC-001 --include "src/" --exclude "node_modules/"
 ```

3. Background Operations: Non-blocking worktree operations
 ```bash
 do-worktree sync --all --background
 ```
...
jobs:
 ...
 do-worktree new test-spec "Test Worktree"

 # Test worktree synchronization
 do-worktree sync test-spec

 # Test worktree cleanup
 do-worktree remove test-spec
```
...
pipeline {
 ...
 sh '''
 pip install do-adk
 do-worktree config set worktree_root $WORKSPACE/worktrees
 '''
 }
 }
 ...
 steps {
 sh '''
 do-worktree new SPEC-AUTH-001 "Authentication Worktree"
 ...
 steps {
 sh '''
 do-worktree new SPEC-PAY-001 "Payment Worktree"
...
- Integration with Do workflow commands
...
git clone https://github.com/your-org/do-adk.git
...
Version: 1.0.0
Last Updated: 2025-11-29
Reference: External resources and additional learning materials for do-worktree
