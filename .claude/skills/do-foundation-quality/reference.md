...
Complete API reference and technical documentation for the do-foundation-quality skill.
...
class QualityConfig:
 ...
 output_directory: str = ".do/reports/quality"
...
This comprehensive reference documentation provides complete API coverage for the do-foundation-quality skill, including all classes, methods, configuration options, and integration patterns needed for enterprise code quality management.
