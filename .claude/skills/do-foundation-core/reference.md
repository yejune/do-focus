...
- Core Principle: Do delegates all work through Task() calls
...
from do_foundation_core import TRUST5Validator
...
from do_foundation_core import SPECManager, TDDExecutor, DocsGenerator
...
from do_foundation_core import TaskAnalyzer, AgentRouter
...
from do_foundation_core import TokenMonitor, ContextOptimizer
...
do-trust check --all --verbose

# Token budget analysis
do-context analyze --show-breakdown

# Agent routing debug
do-agent route --task "description" --dry-run

# SPEC validation
do-spec validate SPEC-001 --format EARS
```

### Validation Utilities

```python
from do_foundation_core import diagnose
...
- TRUST 5 logs: `.do/logs/trust5/`
- SPEC artifacts: `.do/specs/`
- Agent execution logs: `.do/logs/agents/`
- Token usage history: `.do/logs/tokens/`
...
- Do Documentation: See project README
...
- do-foundation-claude - Claude Code integration patterns
- do-workflow-project - Project management with core principles
- do-workflow-testing - Testing workflows with TRUST 5
- do-workflow-templates - Template management integration
