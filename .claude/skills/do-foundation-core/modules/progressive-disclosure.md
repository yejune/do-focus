...
# Validate skill
result = validator.validate_skill(".claude/skills/do-foundation-core")
...
if not result["valid"]:
 ...
 # Auto-split
 validator.auto_split_skill(".claude/skills/do-foundation-core")
...
# Usage
loader = ProgressiveContentLoader(".claude/skills/do-foundation-core")
...
Skills:
- do-foundation-modular-system - File organization patterns
- do-foundation-token-optimization - Content efficiency
- do-cc-skill-factory - Skill creation with progressive structure
...
Commands:
- /do:1-plan - Generate SPEC with progressive detail
- /do:3-sync - Create docs with layered structure
